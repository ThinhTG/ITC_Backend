...
namespace ITC.Services.WalletService
{
	...
	{
		Task AddWalletTransactionAsync(Guid walletId, decimal amount, string transactionType, string transactionStatus, DateTimeOffset transactionDate, decimal transacionBalance, int? orderId);
